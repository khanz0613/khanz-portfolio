    ...
    <div className="min-h-screen bg-slate-50 pt-16">
      <section className="gradient-bg border-b border-slate-200">
        <div className="container-width section-padding section-shell">
          ...
          <h1 className="mt-3 text-4xl font-black text-slate-900 md:text-5xl">소개</h1>
        ...
        <div className="container-width section-padding grid grid-cols-1 gap-6 lg:grid-cols-3">
          <article className="interactive-card rounded-lg border border-slate-200 bg-white p-6 lg:col-span-2">
            <div className="mb-4 flex items-center gap-2">
              ...
              <h2 className="text-xl font-black text-slate-900">개발자로서의 방식</h2>
            </div>
          ...
          <article className="interactive-card rounded-lg border border-slate-200 bg-white p-6">
            <h2 className="text-xl font-black text-slate-900">기본 정보</h2>
            <ul className="mt-4 space-y-2 text-sm text-slate-700">
              <li>
      ...
      <section className="section-shell border-y border-slate-200 bg-white">
        <div className="container-width section-padding">
          <h2 className="text-3xl font-black text-slate-900">경험</h2>
          <div className="mt-6 space-y-4">
            {experienceItems.map((item) => (
              <article key={item.title} className="rounded-lg border border-slate-200 bg-slate-50 p-5">
                <p className="text-xs font-bold uppercase text-slate-500">{item.period}</p>
        ...
        <div className="container-width section-padding grid grid-cols-1 gap-6 lg:grid-cols-2">
          <article className="interactive-card rounded-lg border border-slate-200 bg-white p-6">
            <div className="mb-4 flex items-center gap-2">
              ...
              <h2 className="text-xl font-black text-slate-900">수상</h2>
            </div>
            {awards.map((award) => (
              <div key={award.title} className="rounded-lg bg-emerald-50 p-4">
                <p className="text-xs font-bold uppercase text-emerald-700">{award.period}</p>
          ...
          <article className="interactive-card rounded-lg border border-slate-200 bg-white p-6">
            <div className="mb-4 flex items-center gap-2">
              ...
              <h2 className="text-xl font-black text-slate-900">대외 활동</h2>
            </div>
            <div className="rounded-lg bg-amber-50 p-4">
              <p className="text-xs font-bold uppercase text-amber-700">2018.03 - 2024.02</p>
